...
const Layout = () => {
    ...
    const notifications = [
        ...
        { id: 4, text: "System maintenance scheduled.", time: "3 hr ago" },
    ];
        ...
        w-64 md:w-30 flex flex-col justify-between`}
            >
                ...
                <div className="flex items-center justify-center pt-4">
                    <img src={SaloonLogo} alt="Saloon Logo" className="w-25 h-25 md:w-16 md:h-16 object-contain" />
                </div>
                ...
                md:rounded-full md:py-8 md:px-5">
                    {menuItems.map((item) => (
                        <button
                            ...
                            className={`flex items-center py-4 rounded-xl w-full md:justify-center sm:justify-start md:p-2 md:py-3 pl-10 transition-all ${location.pathname === item.path
                                ? "bg-[#01ABAB] text-white"
                                : "text-gray-500 hover:bg-[#01ABAB]/10 hover:text-[#01ABAB]"
                                }`}
                        >
                            {item.icon}
                            {menuOpen && <span className="text-sm md:hidden block ml-2">{item.label}</span>}
                        </button>
                    ))}
                ...
                <header className="flex justify-between items-center bg-gray-100 px-4 md:px-8 py-4 relative">
                    ...
                    <div className="flex items-center space-x-6 relative">
                        ...
                        <div className="relative hidden md:block">
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        d="M14.857 17.25A2.25 2.25 0 0112.75 19.5h-1.5a2.25 2.25 0 01-2.107-2.25m6.714 0a48.108 48.108 0 01-8.714 0m8.714 0A2.251 2.251 0 0018 15V9.75A6.75 6.75 0 005.25 9.75V15a2.251 2.251 0 001.5 2.25m8.107 0a48.108 48.108 0 01-8.714 0"
                                    />
                                </svg>
                                {unread > 0 && (
                            ...
                            {showNotifications && (
                                <div className="absolute right-0 mt-3 w-80 bg-white shadow-xl rounded-xl border border-gray-100 p-4 z-50">
                                    ...
                                    <ul className="space-y-2 max-h-56 overflow-y-auto">
                                        {notifications.slice(0, 3).map((n) => (
                                            <li key={n.id} className="p-2 rounded-lg hover:bg-gray-50">
